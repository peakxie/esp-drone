...
#include "filter.h"
  ...
  #define PID_ROLL_RATE_KD  6.5
  #define PID_ROLL_RATE_INTEGRATION_LIMIT    500.0

  #define PID_PITCH_RATE_KP  300.0
  #define PID_PITCH_RATE_KI  0.0
  #define PID_PITCH_RATE_KD  6.5
  #define PID_PITCH_RATE_INTEGRATION_LIMIT   500.0

  #define PID_YAW_RATE_KP  200.0
  #define PID_YAW_RATE_KI  18.5
  #define PID_YAW_RATE_KD  0.0
  #define PID_YAW_RATE_INTEGRATION_LIMIT     50.0
  ...
  #define PID_YAW_KP  20.0
  #define PID_YAW_KI  0.0
  #define PID_YAW_KD  1.5
