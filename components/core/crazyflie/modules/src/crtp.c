...
void crtpInit(void)
{
  ...
  STATIC_MEM_TASK_CREATE_PINNED(crtpTxTask, crtpTxTask, CRTP_TX_TASK_NAME, NULL, CRTP_TX_TASK_PRI, COMM_TASK_CORE);
  STATIC_MEM_TASK_CREATE_PINNED(crtpRxTask, crtpRxTask, CRTP_RX_TASK_NAME, NULL, CRTP_RX_TASK_PRI, COMM_TASK_CORE);
