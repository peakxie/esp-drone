...
/* Convert the raw 24-bit readings, as fetched through the MPU6050 I2C-master
 * slave registers, into physical units. */
...
/* Direct read over the main I2C bus, only usable in bypass mode. */
